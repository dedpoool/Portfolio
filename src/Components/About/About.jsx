  ...
  return (
    <div className='flex justify-start h-screen'>
        ...
        <div className='h-1/2 w-1/2 p-8 '>
            ...
            <p className='text-2xl font-mono text-gray-700 leading-10 tracking-widest'>This is about me my name is vishal yadav and I am tring to be a great developer who can make websites web applications like piece of cake for that in am going to practice and learn new coding concepts every day and hond my skills to perfection and after that in will use those skills to make a product or to run my own business with my team with Sahil, Rick, Ninder or someone else willing to help to company grow and after that we will just manage that company and earn enough to do something for poors and animals 🕊️.</p>
        </div>
    </div>
  )
}
